            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <!-- Find Admin -->
                  <?php
                  include '../php/_show-update-admin.php';
                  ?>
                  <!-- Find Admin -->
                  ...
                  <div class="x_content">
                    ...
                    <form   class="form-horizontal form-label-left" method="post" action="../php/_update-admin.php">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Change Email
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="emailCheck" required class="form-control col-md-7 col-xs-12" name="updateEmail" value="<?php echo $email; ?>">
                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success" id="btnCreateAdmin" name="">Update Admin</button>
                        </div>
                      </div>
                    </form>
                  </div>
                  ...
                  <div class="x_content">
                    ...
                    <h3 style="text-align:center;" class="text-success">
                        ...
                        if (isset($_SESSION['successPassChange'])) {
                            echo $_SESSION['successPassChange'];
                            unset($_SESSION['successPassChange']);
                        }

                        ?>
                    </h3>
                    <form class="form-horizontal form-label-left" action="../php/_update-admin-password.php" method="post">
                      <div class="form-group">
